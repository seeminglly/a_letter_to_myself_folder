...
class RecommendationFeedback(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE) # auath에서 커스텀해놓은 user 모델 사용
...
class Feedback(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE) # auth에서 커스텀해놓은 user 모델 사용
    item_title = models.TextField()
